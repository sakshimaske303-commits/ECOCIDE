        ...
        "input": {
            ...
            "data": [{
                ...
                "dataFilter": {
                    ...
                    "maxCloudCoverage": 40,  # relaxed from 20
                    "mosaickingOrder": "leastCC"
                }
            }],
        },
        "output": {"width": 1600, "height": 1200, "responses": [{"identifier": "default", "format": {"type": "image/png"}}]},
...
def main():
    ...
    # Widened window: April through mid-June, but excluding the actual
    # flood event window to keep this genuinely a "before" image
    print("Downloading BEFORE image (widened: April 1 - May 31, 2023)...")
    download_image(access_token, "2023-04-01", "2023-05-31", "before_may2023_v2.png")
