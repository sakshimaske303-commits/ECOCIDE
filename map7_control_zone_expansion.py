...
ROWS = [
    {"label": "Kherson vs. Tulcea\n(original single control)", "coef": -0.0703,
...
def main():
    ...
    fig.text(0.5, 0.97, "CONTROL-ZONE EXPANSION: DOES THE EFFECT HOLD AGAINST EACH CONTROL?", fontsize=15.5,
    ...
    plt.savefig("outputs/plots/control_zone_expansion.png", dpi=220, facecolor=BACKGROUND, bbox_inches="tight")
    plt.close()
    print("Saved: outputs/plots/control_zone_expansion.png")
