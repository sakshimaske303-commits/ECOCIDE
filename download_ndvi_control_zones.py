...
# Three more Danube/Black Sea Romanian counties, bordering Tulcea, forming the
# four-county control panel alongside it — same non-combatant status, same
# general deltaic/floodplain ecology, same acquisition window and evalscript
# as Tulcea's pull so all four batches are directly comparable. Bounding
# boxes taken from GADM Level 1 (see extract_control_zone_boundaries.py).
ZONES = {
    "galati": (27.2276, 45.3905, 28.2345, 46.1633),
    "constanta": (27.2729, 43.7356, 28.9943, 44.8041),
    "braila": (27.0680, 44.7500, 28.1992, 45.4926),
}
...
def main():
    ...
    # Same window as the Kherson/Tulcea pull, so every zone lines up
    # month-for-month in the panel
